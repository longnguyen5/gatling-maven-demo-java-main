...
/**
 * TC_VU_004: Image Rendering Test - 400 Users
 * 400 người dùng truy cập trang có nhiều hình ảnh
 * Expected: Thời gian phản hồi trung bình < 15s, tỷ lệ thành công > 70%
 */
...

  {
    setUp(
      imageRenderingScenario.injectOpen(
        rampUsers(400).during(Duration.ofMinutes(3))
      )
