...
/**
 * TC_VU_004: Image Rendering Test - 100 Users
 * 100 người dùng truy cập trang có nhiều hình ảnh
 * Expected: Thời gian phản hồi trung bình < 10s, tỷ lệ thành công > 80%
 */
public class _100_Users extends Simulation {
...

  {
    ...
    .assertions(
      global().responseTime().mean().lte(10000),
      global().responseTime().percentile3().lte(20000),
