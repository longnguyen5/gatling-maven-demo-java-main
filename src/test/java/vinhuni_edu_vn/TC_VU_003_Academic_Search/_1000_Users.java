...
/**
 * TC_VU_003: Academic Search Test - 1000 Users (Stress Test)
 * 1000 người dùng tìm kiếm chương trình đào tạo
...
public class _1000_Users extends Simulation {
...

  {
    ...
    .assertions(
      global().responseTime().mean().lte(20000),
      global().responseTime().percentile3().lte(40000),
      global().successfulRequests().percent().gte(50.0)
    );
  }
}
